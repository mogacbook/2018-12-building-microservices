...
> 상호 의존성을 가진 마이크로서비스의 배포는 모놀식과 전혀 다르다.
...
> 루비 gem, 자바 jar file / war file, 파이썬 egg 등
...
이후 3개월동안 10-15개, 18개월 후에는 60-70개 이상의 마이크로서비스로 변환 <br/>
__길트(온라인패션몰)__
모놀리식 레일즈 애플리케이션은 확장성에 어려움을 겪기 시작, 2009년에 시스템을 마이크로서비스로 분해하기로 결정<br/>
개발자를 돕는 도구인 자동화는 길트의 마이크로서비스 사용을 촉발시키는 핵심요인이 됨<br/>
