...
REA - 주요사업은 부동산이지만 다양한 개별 사업 영역(LOB)을 보유<br/>
LOB 내 모든 서비스는 하나의 관리팀이 관장하기 때문에 그들이 생각하기 합당하다면 서비스들은 어떤 방식으로든 자유롭게 통신할 수 있다. 그러나 LOB 간 모든 통신은 아주 작은 아키텍처 팀의 불변의 법칙 중 하나인 비동기 배치 방식으로 정해져 있다. 이러한큰 단위의 커뮤니케이션은 사업의 다른 부분 사이에 이용되는 큰 단위의 통신과 일치한다.<br/>
배치 방식을 고수함에 따라 각 LOB는 동작하고 관리하는 방식에 있어 더 많은 자유도를 가진다.<br/>
-> 수년전까지만 해도 몇 안되는 서비스만 운영하던 REA는 지금 수 백개의 서비스를 운영하며 빠른 속도로 성장 중

>> 시스템 아키텍처 뿐 아니라 조직 구조 변경에 충분히 잘 적응할 수 있는 조직은 팀 자율성의 향상과 새로운 제품 특징 및 기능의 더 빠른 출시 속도로 인해 엄청난 이득을 창출한다
*****
<br/>

## 콘웨이의 역법칙
시스템 설계가 조직을 변경할 수 있을까?<br/>
한 예로 조직 구조는 시스템 설계에 맞춰 성장했다<br/>
*****
<br/>

## 사람
마이크로서비스 환경에서는 개발자가 자신의 작은 세계에서 코드 작성만 생각하는 것은 더 힘들다는 것을 받아드려야 한다. <br/>
예) 네트워크 경계 간 호출이나 실패 같은 내포 의미를 알아야 하는 등<br/>
마찬가지로 자율성을 높이도록 개발팀을 떠미는 것도 문제가 될 수 있다<br/>
>> 마이크로서비스 세계에서 사람들의 책임을 명확히 구분해야 한다<br/>
>> 책임이 여러분에게도 중요한 이유를 명확히 하라
*****
<br/>

## 마치며
콘웨이의 법칙은 시스템을 조직 구조와 다르게 설계할 때의 위험을 강조<br/>
이 법칙은 서비스의 소유권을 동일 위치의 팀과 나란히 정렬시킬 수 있도록 해주며 그 팀은 스스로 조직의 경계와 동일한 경계가 있는 콘텍스트 주위로 정렬

>> 우리는 서비스 소유권과 조직 간의 관계를 이해함으로써 구축할 시스템과 조직이 부합되도록 해야 한다
*****
<br/>
